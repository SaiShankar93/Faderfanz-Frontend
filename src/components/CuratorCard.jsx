        ...
        (<div>
            ...
            >
                <BackgroundGradient className="rounded-[22px]   p-4 sm:p-10 bg-[#181818]">
                    ...
                    <div className="">
                        <p className="flex justify-center text-center my-1 text-sm text-gray-400 mb-2">{event.contact ? event.contact : "djblaze@example.com"}</p>
                        <p className="flex justify-center text-center my-1 text-sm text-gray-500">Followers: {event.followers ? event.followers.toLocaleString() : 143}</p>
                    </div>
