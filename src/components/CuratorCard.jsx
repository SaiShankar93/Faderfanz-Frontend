    ...
    return (
        <div className="backdrop-blur-sm border border-[#565656] rounded-lg">
            ...
            <div className="p-6 flex flex-col gap-4">
                {/* Name */}
                <h3 className="text-white text-2xl font-semibold text-center">{event?.name}</h3>

                {/* Stats */}
                <div className="grid grid-cols-3 gap-4">
                    <div className="flex flex-col items-center">
                        <BsCalendarEvent className="text-[#C5FF32] text-xl" />
                        <p className="text-[#C5FF32] text-2xl font-bold mt-2">{event?.performances}</p>
                        <p className="text-gray-400 text-sm">Performances</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <BsPeople className="text-[#C5FF32] text-xl" />
                        <p className="text-[#C5FF32] text-2xl font-bold mt-2">{event?.followers}</p>
                        <p className="text-gray-400 text-sm">Followers</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <AiFillStar className="text-[#C5FF32] text-xl" />
                        <p className="text-[#C5FFB2] text-2xl font-bold mt-2">{event?.rating}</p>
