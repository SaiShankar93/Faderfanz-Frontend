            ...
            <div
                ...
                <div className="relative z-10 flex items-center justify-center">
                    <div
                        ...
                        <img src={link} alt="" className="rounded-full" />
                    </div>
                </div>
            </div>
        </div>)
...
export function CardPattern({
    ...
    return (
        (<div className="pointer-events-none">
            ...
            <motion.div
                className="absolute inset-0 rounded-2xl bg-gradient-to-r to-[#FF44EC] via-[#FF675E] from-[#44BCFF] opacity-0  group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
                style={style} />
            <motion.div
